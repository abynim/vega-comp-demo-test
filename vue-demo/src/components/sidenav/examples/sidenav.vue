<script>
import { VegaFlex, VegaSidenav, VegaSidenavGroup, VegaSidenavLink } from "@heartlandone/vega-vue"

export default {
  data() {
    return {}
  },
  components: { VegaFlex, VegaSidenav, VegaSidenavGroup, VegaSidenavLink }
}
</script>
<template>
  <VegaFlex>
    <div data-shrink="0">
      <VegaSidenav
        ...
        open-by-default="disableCollapse"
      >
        <VegaSidenavLink
          icon="hb-menu"
          url="#"
        ...
        <VegaSidenavLink
          icon="fas fa-shopping-bag fa-lg"
          url="#"
        >
          Order Equipment
        </VegaSidenavLink>
