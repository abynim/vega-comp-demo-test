...
@Component({
  selector: "app-table-density-compact",
  templateUrl: "./table-density-compact.component.html",
  styleUrls: ["./table-density-compact.component.scss"]
})
export class TableDensityCompactComponent {
