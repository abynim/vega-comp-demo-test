...
@Component({
  selector: "app-table-density-default",
  templateUrl: "./table-density-default.component.html",
  styleUrls: ["./table-density-default.component.scss"]
})
export class TableDensityDefaultComponent {
