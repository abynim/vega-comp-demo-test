...
@Component({
  selector: "app-table-density-responsive",
  templateUrl: "./table-density-responsive.component.html",
  styleUrls: ["./table-density-responsive.component.scss"]
})
export class TableDensityResponsiveComponent {
